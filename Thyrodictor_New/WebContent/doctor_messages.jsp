...
<html lang="en">
  <head>
  	...
  	function validate(){
    	var email=document.mail.user_id.value;
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="doctor_messages.jsp?status="><span class="glyphicon glyphicon-envelope"></span></a></li><li></li>
                 <li class="dropdown">
  ...
  <!-- =======Home Sectionn======= -->
    ...
    <section id="service">
      <div class="container">
         <div class="col-lg-4 col-md-4">
			<div class="row">
				<div class="readmore_area" align="right">
					<a data-toggle="modal" data-target="#myModal-6" href="#" data-hover="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Compose&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Compose&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
				</div>
				              <!-- start modal window -->
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="appointment-area">
                        <form class="appointment-form"  id="mail" name="mail" method="post" action="doctor_send_mail.jsp"  onsubmit="return validate();">
                        
                        	<div class="row">
                             <div class="col-md-4 col-sm-4">
                              <label for="user_id" class="control-label">To: <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-8 col-sm-8">
                              <input type="text" id="user_id" name="user_id" class="wp-form-control wpcf7-email" placeholder="Reciever address" onchange="return msgDelete();">
                              <p id="error"></p>  
                            </div>
                            </div> 
			...
			<div class="row">
				<div class="readmore_area" align="right">
					<a href="doctor_sent_messages.jsp" data-hover="Sent Messages"><span>Sent Messages</span></a>    
				</div>
			</div>
         </div>
         ...
         <%
         String newmsg = "";
         ResultSet rs1 = stmt.executeQuery("select * from messages where message_receiver_id='"+un+"' and message_receiver_status!='deleted' order by message_id desc;");
         if(rs1.next()){
        	 if ((rs1.getString(7)).equals("recieved")){
        		 newmsg="new";
        	 }else{
        		 newmsg="";
        	 }
        	 ...
        	 <table class="table">
        	 	...
        	 	<tr>
        	 		<td>
        	 		<a href="doctor_view_sender.jsp?userid=<%=rs1.getString(2) %>"><%=rs1.getString(2) %></a>
        	 		</td>
        	 		<td>
        	 		<%=rs1.getString(4) %>
        	 		<sup style="color: red;"><%=newmsg %></sup>
        	 		</td>
        	 		<td>
        	 		<a href="doctor_view_received.jsp?msgid=<%=rs1.getString(1) %>">View</a>
        	 		</td>
        	 		<td>
        	 		<a href="doctor_message_delete.jsp?status=receiver&msgid=<%=rs1.getString(1) %>"><span class="glyphicon glyphicon-trash"></span></a>
        	 		</td>
        	 	</tr>
        	 	<%
        	 	while(rs1.next()){
