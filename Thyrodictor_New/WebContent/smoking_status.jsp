 ...
 */
   ...
   String namedb = "thyrodictor";  // MySQL database name
...
--> 
        <script src="/Thyrodector/scripts/fusioncharts.js"></script>
    </head>
    <body>
         <div id="chart"></div>
...
-->           
         ...
         */
            ...
            chartobj.put("caption", "Personal Analysis");
            chartobj.put("subCaption" , "TSH");
