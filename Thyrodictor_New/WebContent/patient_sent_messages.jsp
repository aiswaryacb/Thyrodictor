      ...
      <div class="container">
         ...
         if(rs1.next()){
        	 ...
        	 <table class="table">
        	 	...
        	 	<tr>
        	 		<td>
        	 		<a href="patient_view_sender.jsp?userid=<%=rs1.getString(3) %>"><%=rs1.getString(3) %></a>
        	 		</td>
        	 		<td>
        	 		<%=rs1.getString(4) %>
        	 		</td>
        	 		<td>
        	 		<a href="patient_view_sent.jsp?msgid=<%=rs1.getString(1) %>">View</a>
        	 		</td>
        	 		<td>
        	 		<a href="patient_message_delete.jsp?status=sender&msgid=<%=rs1.getString(1) %>"><span class="glyphicon glyphicon-trash"></span></a>
        	 		</td>
        	 	</tr>
        	 	<%
        	 	while(rs1.next()){
