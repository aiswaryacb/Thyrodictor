          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              <div class="blog-breadcrumbs-left">
                <h2>ADMINISTRATION - View Doctors</h2>
              </div>
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li><a href="admin_view_doctors.jsp">View Doctors</a></li>
...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		int slno=0;
	              ResultSet rs = stmt.executeQuery("select * from doctor_details where doctor_id='"+doc+"';");
	              
	              if(rs.next()){
	            	  String placeid=rs.getString(4);
		              	String place="";
		              	for(i=0;i<n;i++){
	            	 ...
	            	 <%
	            	 ResultSet rs1= stmt.executeQuery("select * from hospital_details where doctor_id='"+doc+"';");
		             if(rs1.next()){
		            	 %><h3><center>HOSPITAL DETAILS</center></h3>
		            	 <table class="table">
				        	<thead>
				        	<tr>
				        		<th>Hospital Name</th>
	            	  ...
	            	  %>
	            	  <h4>No doctor details to show!!</h4>
	            	  <%
	              }
				} con.close();	
				}
