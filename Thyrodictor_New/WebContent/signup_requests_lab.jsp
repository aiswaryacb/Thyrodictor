...
<html lang="en">
  <head>
  	<script>
  	function deny(){
  		document.status.action = "signup_lab_deny.jsp"; 
  	}
  	function accept(){
  		document.status.action = "signup_lab_accept.jsp"; 
  	}
  	</script>
            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Lab Signup Requests</li>
                </ol>
              </div>
            </div>
          </div>
...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		int slno=1;
	              ResultSet rs = stmt.executeQuery("select * from lab_details where lab_status='requested';");
	              if(rs.next()){
	            	  %>
	            	  <table class="table">
	            	  <thead>
		            	  ...
		            	  <td>
		            	  <!-- form action="signup_lab_accept.jsp" method="post" id="status" name="status">
		            	  <input type="hidden" value="<%=rs.getString(1) %>" id="lab_id" name="lab_id"-->
		            	  <a href="signup_lab_deny.jsp?lab_id=<%=rs.getString(1) %>">Deny</a>
		 					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            	  <a href="signup_lab_accept.jsp?lab_id=<%=rs.getString(1) %>">Accept</a>
		            	  <!--input type="submit" value="Accept">
		            	  <input type="button" value="Deny" onclick="action:signup_lab_deny.jsp"-->
		            	  </form>
		            	  </td>
	            	  	</tr>
	            	  	<%
	                  while(rs.next()){
		            	  ...
		            	  <td>
		            	  <a href="signup_lab_deny.jsp?doc_id=<%=rs.getString(1) %>">Deny</a>
		            	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            	  <a href="signup_lab_accept.jsp?doc_id=<%=rs.getString(1) %>">Accept</a>
		            	  </td>
	            	  	</tr>
