...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		int slno=1;
	              ResultSet rs = stmt.executeQuery("select * from lab_details where lab_status='accepted';");
	              ...
	              if(rs.next()){
	            	  ...
	            	  <thead>
		            	  ...
		            	  <td>
		            	  <a href="admin_lab_details.jsp?lab=<%=rs.getString(1)%>"><%=rs.getString(2) %></a>
		            	  </td>
		            	  <td>
		            	  <%=rs.getString(3) %>
		            	  </td>
