...
if(usertype.equals("patient")){
	...
	%>
	<br><br>
	<div class="row"><center><i><b>Hospital Details</b></i></center></div>
	<br><br>
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4"><%=rs3.getString(7) %></div>
			<div class="col-lg-2 col-md-2"></div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
			<div class="col-lg-4 col-md-4">Phone: </div>
			<div class="col-lg-4 col-md-4"><%=rs3.getString(8) %></div>
			<div class="col-lg-2 col-md-2"></div>
		</div>
