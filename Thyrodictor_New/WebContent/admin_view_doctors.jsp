...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		int slno=1;
	              ResultSet rs = stmt.executeQuery("select * from doctor_details where doctor_status='accepted';");
	              ...
	              if(rs.next()){
	            	  ...
	            	  <thead>
		            	  ...
		            	  <td>
		            	  <a href="admin_doctor_detail.jsp?doc=<%=rs.getString(1) %>"><%=rs.getString(3) %></a>
		            	  </td>
		            	  <td>
		            	  <%=rs.getString(2) %>
		            	  </td>
