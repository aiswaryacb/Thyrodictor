  ...
  <body>    
   ...
   <section id="service">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12">
               <form class="appointment-form"  id="search" name="search" method="post" action="lab_search_db.jsp"">
                    <div class="row">
        ...
        <div class="row">
        <%
		 ResultSet rs1= stmt.executeQuery("select * from patient_details where patient_name='"+sname+"' or patient_name like '%"+sname+"%' order by patient_name;");
