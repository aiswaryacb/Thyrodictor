                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="single-service">
                      <div class="appointment-area">
                        <form class="appointment-form"  id="state_analysis" name="state_analysis" method="post" action="area_analysis_state_results.jsp" >
                        <div class="row">
 ...
 <%
     ...
     %>
                        ...
                        <div class="col-md-2 col-sm-2"></div>
                         ...
                         <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-share"></i><span>Go</span></button>  
                         </div>
                         <div class="col-md-4 col-sm-4"></div>
                         </div>
                        </form>
