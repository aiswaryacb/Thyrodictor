                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_area_analysis.jsp" data-hover="Signup Requests"><span>Area Analysis</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="signup_requests_doctors.jsp" data-hover="Signup Requests"><span>New Doctors</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="signup_requests_lab.jsp" data-hover="Signup Requests"><span>New Laboratories</span></a></h3>
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="add_state.jsp" data-hover="Add New State"><span>Add New States</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="add_district.jsp" data-hover="Add New District"><span>Add New District</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="backup.jsp" data-hover="Data Backup"><span>Data Backup</span></a></h3>
                    </div>
                  </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_view_patients.jsp" data-hover="View Patients"><span>View Patients</span></a></h3>
                    </div>
                  </div>
                <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_view_doctors.jsp" data-hover="View Doctors"><span>View Doctors</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_view_labs.jsp" data-hover="View Labs"><span>View Labs</span></a></h3>
                    </div>
                  </div>
                 </div>
                 <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_update_learning_data.jsp" data-hover="View Doctors"><span>Update Learning Data</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="admin_learn.jsp" data-hover="View Doctors"><span>Learn from Dataset</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="restore.jsp" data-hover="View Doctors"><span>Restore</span></a></h3>
                    </div>
                  </div>
                </div>
              </div>
