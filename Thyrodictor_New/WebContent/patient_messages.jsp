      ...
      <div class="container">
         <div class="col-lg-4 col-md-4">
			<div class="row">
				<div class="readmore_area" align="right">
					<a data-toggle="modal" data-target="#myModal-7" href="#" data-hover="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Compose&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Compose&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
				</div>
				              <!-- start modal window -->
                        ...
                        <form class="appointment-form"  id="mail" name="mail" method="post" action="patient_send_mail.jsp"  onsubmit="return validate();">
                        	...
                        	<div class="row">
                             <div class="col-md-4 col-sm-4">
                              ...
                              <input type="text" id="email" name="email" class="wp-form-control wpcf7-text" placeholder="Reciever address" onchange="return msgDelete();">
                              <p id="error"></p>  
                            </div>
                            </div> 
         ...
         if(rs1.next()){
        	 ...
        	 <table class="table">
        	 	...
        	 	<tr>
        	 		<td>
        	 		<a href="patient_view_sender.jsp?userid=<%=rs1.getString(2) %>"><%=rs1.getString(2) %></a>
        	 		</td>
        	 		<td>
        	 		<%=rs1.getString(4) %>
        	 		...
        	 		<td>
        	 		<a href="patient_view_received.jsp?msgid=<%=rs1.getString(1) %>">View</a>
        	 		</td>
        	 		<td>
        	 		<a href="patient_message_delete.jsp?status=receiver&msgid=<%=rs1.getString(1) %>"><span class="glyphicon glyphicon-trash"></span></a>
        	 		</td>
        	 	</tr>
        	 	<%
        	 	while(rs1.next()){
