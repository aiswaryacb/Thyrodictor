  ...
  <body>    
   ...
   <section id="service">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12">
               <form class="appointment-form"  id="search" name="search" method="post" action="patient_search_lab.jsp"">
                    <div class="row">
        ...
        <div class="row">
        <%
		 ResultSet rs1= stmt.executeQuery("select * from lab_details where lab_name='"+sname+"' or lab_name like '%"+sname+"%' order by lab_name;");
			ResultSet rs2;
			String district;
        if(rs1.next()){
