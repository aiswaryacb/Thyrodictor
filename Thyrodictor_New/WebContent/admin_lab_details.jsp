          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              <div class="blog-breadcrumbs-left">
                <h2>ADMINISTRATION - View Labs</h2>
              </div>
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li><a href="admin_view_labs.jsp">View Labs</a></li>
...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		//int slno=1;
	              ResultSet rs = stmt.executeQuery("select * from lab_details where lab_id='"+labid+"';");
	              ...
	              if(rs.next()){
	            	  ...
	            	  <table class="table">
		            	...
		            	<tr>
		            	<td>Timings</td>
		            	<td><%=rs.getString(5)%> to <%=rs.getString(6) %></td>
		            	</tr>
		            	<tr>
		            	<td>Phone</td>
