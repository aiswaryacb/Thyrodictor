...
-->        
   ...
   String namedb = "thyrodictor";  // MySQL database name
	String district="Kottayam";
    // Establish a connection to the database
    DriverManager.registerDriver(new com.mysql.jdbc.Driver());
    Connection con = DriverManager.getConnection("jdbc:mysql://" + hostdb + "/" + namedb , userdb , passdb);
         String sql="select count , thyroid_type from graph_table where district_name='"+district+"'";
         ...
         */
            ...
            chartobj.put("caption", "Area Analysis");
            chartobj.put("subCaption" , district);
