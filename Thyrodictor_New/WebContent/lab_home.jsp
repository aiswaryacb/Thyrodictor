                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="lab_area_analysis.jsp" data-hover="View Area Analysis"><span>Area Analysis</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="lab_test_reports.jsp" data-hover="Personal Analysis"><span>Enter Test Reports</span></a></h3>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-4">
                  	<div class="single-service">
                                           
                      <h3><a href="lab_search_db.jsp" data-hover="Personal Analysis"><span>Search Patients</span></a></h3>
                    </div>
                  </div>
                 </div>
              </div>
