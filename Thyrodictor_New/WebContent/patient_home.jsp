            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Patient Home</li>
                </ol>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="patient_area_analysis.jsp" data-hover="View Area Analysis"><span>Area Analysis</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="patient_personal.jsp" data-hover="Personal Analysis"><span>Personal Analysis</span></a></h3>
                    </div>
                  </div>
                  <!-- Start Single Service -->
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                      ...
                      <h3><a href="patient_test_reports.jsp" data-hover="Enter Test Reports"><span>Enter Test Reports</span></a></h3>
                    </div>
                  </div>
                  </div>
                 <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <div class="single-service">
                        ...
                        %>                  
                      <h3><a href="infant_symptoms.jsp" data-hover="Enter Symptoms"><span>Enter Symptoms</span></a></h3>
                      <%
                        }
					 else if(age<15 && gender.equals("F"))
					 {
					 %>
						 <h3><a href="child_female_symptoms.jsp" data-hover="Enter Symptoms"><span>Enter Symptoms</span></a></h3>
						             <%
						}
						else if(age<15 && gender.equals("M")) 
								 {
								 %>
								 	<h3><a href="child_male_symptoms.jsp" data-hover="Enter Symptoms"><span>Enter Symptoms</span></a></h3>
								<%
								 }
						else if(age>15 && gender.equals("F")) 
						{
							%>
							<h3><a href="adult_female_symptoms.jsp" data-hover="Enter Symptoms"><span>Enter Symptoms</span></a></h3>
						    <%
						}
						else
						{
							%>
							<h3><a href="adult_male_symptoms.jsp" data-hover="Enter Symptoms"><span>Enter Symptoms</span></a></h3>
						    <%
						}
                  ...
                  <div class="col-lg-4 col-md-4">
                      ...
                      <h3><a href="patient_search_lab.jsp?name=" data-hover="Enter Test Reports"><span>Search Labs</span></a></h3>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-4">
                  	<div class="single-service">
                                         
                      <h3><a href="patient_search_doctors.jsp?name=" data-hover="Enter Test Reports"><span>Search Doctors</span></a></h3>
                    </div>
                  </div>
