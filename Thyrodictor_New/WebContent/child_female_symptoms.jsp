...
<html lang="en">
  <head>
    ...
    function msgDelete32()
    {
  	...
  	function validate()
  	{
  		var qn1=document.child_female_symptoms.qn1.value;
  		
  		var qn3=document.child_female_symptoms.qn3.value;
  		var qn4=document.child_female_symptoms.qn4.value;
  		var qn5=document.child_female_symptoms.qn5.value;
  		var qn6=document.child_female_symptoms.qn6.value;
  		var qn7=document.child_female_symptoms.qn7.value;
  		var qn8=document.child_female_symptoms.qn8.value;
  		var qn9=document.child_female_symptoms.qn9.value;
  		var qn10=document.child_female_symptoms.qn10.value;
  		var qn11=document.child_female_symptoms.qn11.value;
  		var qn12=document.child_female_symptoms.qn12.value;
  		var qn13=document.child_female_symptoms.qn13.value;
  		var qn14=document.child_female_symptoms.qn14.value;
  		var qn15=document.child_female_symptoms.qn15.value;
  		var qn16=document.child_female_symptoms.qn16.value;
  		var qn17=document.child_female_symptoms.qn17.value;
  		var qn18=document.child_female_symptoms.qn18.value;
  		var qn19=document.child_female_symptoms.qn19.value;
  		var qn20=document.child_female_symptoms.qn20.value;
  		var qn21=document.child_female_symptoms.qn21.value;
  		var qn22=document.child_female_symptoms.qn22.value;
  		var qn23=document.child_female_symptoms.qn23.value;
  		var qn24=document.child_female_symptoms.qn24.value;
  		var qn25=document.child_female_symptoms.qn25.value;
  		var qn26=document.child_female_symptoms.qn26.value;
  		var qn27=document.child_female_symptoms.qn27.value;
  		var qn28=document.child_female_symptoms.qn28.value;
  		var qn29=document.child_female_symptoms.qn29.value;
  		var qn30=document.child_female_symptoms.qn30.value;
  		var qn31=document.child_female_symptoms.qn31.value;
  		var qn32=document.child_female_symptoms.qn32.value;
  		var flag=true;
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="single-service">
                      <div class="appointment-area">
                        <form class="appointment-form"  id="child_female_symptoms" name="child_female_symptoms" method="post" action="child_symptoms_db.jsp" onsubmit="return validate();">
                        ...
                        <br>
                            ...
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-2 col-sm-4">
                              <label for="qn5" class="control-label">1. Deceleration of growth<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                            ...
                            <div class="col-md-4 col-sm-8">
                              <label for="qn6" class="control-label">2. Rough, dry skin<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-4 col-sm-8">
                              <label for="qn7" class="control-label">3. Constipation<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-4 col-sm-8">
                              <label for="qn8" class="control-label">4. Cold intolerance<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                       ...
                       <br><br>
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-4 col-sm-8">
                              <label for="qn9" class="control-label">5. Fatigue or decreased energy<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn10" class="control-label">6. Sleeping more<span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                       ...
                       <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn11" class="control-label">7. Bruising easily <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn12" class="control-label">8. Headaches <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn13" class="control-label">9. Vision problems <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn14" class="control-label">10. Early or delayed puberty <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn15" class="control-label">11. Emotional liability <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn16" class="control-label">12. Short attension span <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn17" class="control-label">13. Finger tremor <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn18" class="control-label">14. Increased appetite <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn19" class="control-label">15. Weight loss, Failure to thrive <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn20" class="control-label">16. Swelling at the front of the neck <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn21" class="control-label">17. Protruding eyes (Bulging of eyes) <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn22" class="control-label">18. Upper eyelid lag <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn23" class="control-label">19. Infrequent blinking <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn24" class="control-label">20. Flushed skin <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn25" class="control-label">21. Excessive sweating <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                       ...
                       <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn26" class="control-label">22. Muscle weakness <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                       ...
                       <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn27" class="control-label">23. Palpitation (Rapid or forcefull heart beat) <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                        ...
                        <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn28" class="control-label">24. Loss of menstrual periods <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                            ...
                            <div class="col-md-0 col-sm-0">
                              ...
                              <div class="col-md-0 col-sm-0">
                               ...
                               <div class="col-md-0 col-sm-1"> 
                              <input type="radio" id="qn28" name="qn28" class="wp-form-control wpcf7-radio" value="NA" onchange="return msgDelete28();">
                              </div>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn29" class="control-label">25. Irregular periods <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                            ...
                            <div class="col-md-0 col-sm-0">
                              ...
                              <div class="col-md-0 col-sm-0">
                               ...
                               <div class="col-md-0 col-sm-1"> 
                              <input type="radio" id="qn29" name="qn29" class="wp-form-control wpcf7-radio" value="NA" onchange="return msgDelete29();">
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn30" class="control-label">26. Excessive menstrual flow <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                            ...
                            <div class="col-md-0 col-sm-0">
                              ...
                              <div class="col-md-0 col-sm-0">
                               ...
                               <div class="col-md-0 col-sm-1"> 
                              <input type="radio" id="qn30" name="qn30" class="wp-form-control wpcf7-radio" value="NA" onchange="return msgDelete30();">
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn31" class="control-label">27. Have you ever been misscarried during the past two years ? <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                            ...
                            <div class="col-md-0 col-sm-0">
                              ...
                              <div class="col-md-0 col-sm-0">
                               ...
                               <div class="col-md-0 col-sm-1"> 
                              <input type="radio" id="qn31" name="qn31" class="wp-form-control wpcf7-radio" value="NA" onchange="return msgDelete31();">
                              </div>
                      ...
                      <br><br>
                           ...
                           <div class="row">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                              <label for="qn32" class="control-label">28. Pre menstrual syndrome/tension (PMS/PMT) <span class="required">*</span>
                              </label>
                              </div>
                              <div class="col-md-2 col-sm-2"></div>
                              </div>
                            ...
                            <div class="col-md-0 col-sm-0">
                              ...
                              <div class="col-md-0 col-sm-0">
                               ...
                               <div class="col-md-0 col-sm-1"> 
                              <input type="radio" id="qn32" name="qn32" class="wp-form-control wpcf7-radio" value="NA" onchange="return msgDelete32();">
                              </div>
