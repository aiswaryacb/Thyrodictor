  ...
  <%
	...
	if(!con.isClosed()){
		stmt=con.createStatement();
         ...
         //ResultSet rs=stmt.executeQuery("SELECT * FROM thyrodictor.login_details WHERE login_id='"+email+"' AND password='"+pw+"';");
		 ResultSet rs1=stmt.executeQuery("Select * from lab_details where lab_user_id='"+un+"'");  
		 if(rs1.next())
		 {
          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  <li>You are here</li>
                   <li><a href="lab_home.jsp">HOME</a></li>                 
        ...
        <div class="row">
          <div class="col-lg-7 col-md-7 col-sm-6">
            <div class="contact-form">
              ...
              <form name="area_analysis" id="area_analysis" class="submitphoto_form" action="lab_area_analysis_db.jsp" onsubmit="return validate();">
