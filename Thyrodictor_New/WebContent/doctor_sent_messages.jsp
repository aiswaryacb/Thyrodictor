  ...
  <!-- =======Home Sectionn======= -->
    ...
    <section id="service">
      <div class="container">
                        ...
                        <form class="appointment-form"  id="mail" name="mail" method="post" action="doctor_send_mail.jsp"  onsubmit="return validate();">
                        	...
                        	<div class="row">
                             <div class="col-md-4 col-sm-4">
                              ...
                              <input type="text" id="user_id" name="user_id" class="wp-form-control wpcf7-text" placeholder="Reciever address" onchange="return msgDelete();">
                              <p id="error"></p>  
                            </div>
                            </div> 
         ...
         <%
         ResultSet rs1 = stmt.executeQuery("select * from messages where message_sender_id='"+un+"' and message_sender_status!='deleted' order by message_id desc;");
         if(rs1.next()){
        	 %>
        	 <table class="table">
        	 	<thead>
        	 	...
        	 	<tr>
        	 		<td>
        	 		<a href="doctor_view_sender.jsp?userid=<%=rs1.getString(3) %>"><%=rs1.getString(3) %></a>
        	 		</td>
        	 		<td>
        	 		<%=rs1.getString(4) %>
        	 		</td>
        	 		<td>
        	 		<a href="doctor_view_sent.jsp?msgid=<%=rs1.getString(1) %>">View</a>
        	 		</td>
        	 		<td>
        	 		<a href="doctor_message_delete.jsp?status=sender&msgid=<%=rs1.getString(1) %>"><span class="glyphicon glyphicon-trash"></span></a>
        	 		</td>
        	 	</tr>
        	 	<%
        	 	while(rs1.next()){
