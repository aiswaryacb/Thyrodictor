...
<html lang="en">
  <head>
    ...
    <![endif]--> 
     ...
     function validate(){
     	var name=document.addstate.state.value;
     	var flag=true;

     	if(name==""|| name==null){
    		
    		fontcolor="red";
    		document.getElementById('perror').innerHTML= "<span style=\"color:red\">Enter State Name </span>";
    		flag=false;
    		//return false;
    	}
        ...
        <div class="row">
          <div class="col-lg-7 col-md-7 col-sm-6">
            <div class="contact-form">
              ...
              <p>You can add new states in india....</p>
              <form class="submitphoto_form" action="add_state_db.jsp" name="addstate" onsubmit="return validate();">
              <label for="state" class="control-label">Enter State Name :<span class="required"></span>
                              </label>
                <input type="text" class="wp-form-control wpcf7-text" placeholder="State Name" name="state" id="state" onchange="return onlyAlphabets(event,this);" onkeypress="return onlyAlphabets(event,this);">
                <br>
                <p id="perror"></p>
