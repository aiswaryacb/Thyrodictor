   ...
   <section id="service">
      <div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4">Lab Id: </div>
		...
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
			<div class="col-lg-4 col-md-4">District: </div>
			<div class="col-lg-4 col-md-4"><%=rs.getString(4) %></div>
			<div class="col-lg-2 col-md-2"></div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
			<div class="col-lg-4 col-md-4">Lab opening time: </div>
			<div class="col-lg-4 col-md-4"><%=rs.getString(5) %></div>
			<div class="col-lg-2 col-md-2"></div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
			<div class="col-lg-4 col-md-4">Lab closing time: </div>
			<div class="col-lg-4 col-md-4"><%=rs.getString(6) %></div>
			<div class="col-lg-2 col-md-2"></div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2"></div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4"><div class="readmore_area" align="right">
					<a href="lab_update.jsp" data-hover="UPDATE"><span>UPDATE</span></a>    
				</div></div>
			<div class="col-lg-4 col-md-4"></div>
		</div>
      </div>
