            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="patient_messages.jsp"><span class="glyphicon glyphicon-envelope"></span></a></li><li></li>
                 <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-log-out"></span></a>
            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li><a href="patient_test_reports.jsp">SYMPTOMS</a></li>               
                  <li class="active">Prediction Results</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="service-area">
              ...
              <div class="section-heading">
                <h2>Prediction result is ready!</h2>
                <%
                if(result.equals("hypo")){
                	result="There is a high chance of Hypothyroidism";
                }
                else if(result.equals("hyper")){
                	result="There is a high chance of Hyperthyroidism";
                }
                else if(result.equals("goiter")){
                	result="There is a high chance of Goiter";
                }
                else if(result.equals("cancer")){
                	result="There is a high chance of Thyroid Cancer";
                }
                else{
                	result="You may not have any thyroid problem";
                }
                %>
