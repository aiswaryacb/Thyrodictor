...
<script language="javascript" type="text/javascript">
  ...
  function msgDelete7()
  {
  	document.getElementById('terror7').innerHTML= "";
  }
  
  function test_validate(){
	var userid=document.test.userid.value;
	...
	if(userid==""|| userid==null){
		...
		fontcolor="red";
		document.getElementById('terror7').innerHTML= "<span style=\"color:red\">Enter Patient User Id</span>";
		flag=false;
            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Enter Reports</li>
                </ol>
              </div>
            </div>
          </div>
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="single-service">
                      <div class="appointment-area">
                        <form class="appointment-form"  id="test" name="test" method="post" action="lab_test_analysis.jsp" onsubmit="return test_validate();">
                        <div class="row">
                        <div class="col-md-2 col-sm-2"></div>
                        <div class="col-md-8 col-sm-8">
                              <label for="patientid" class="control-label">User ID<span class="required">*</span>
                              </label>
                              <input type="text" id="userid" name="userid" class="wp-form-control wpcf7-text" placeholder="Enter Patient id" onchange="return msgDelete7();">    
                               <br>
                        <p id="terror7"></p>                           
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                        ...
                        <div class="col-md-8 col-sm-8">
                              ...
                              <input type="text" id="t3" name="t3" class="wp-form-control wpcf7-text" placeholder="Enter T3 value"onkeypress="return onlyNumbers(event,this);" onchange="return onlyNumbers(event,this);">  
                              <br>
                        <p id="terror3"></p>                            
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                        ...
                        <div class="col-md-8 col-sm-8">
                              ...
                              <input type="text" id="t4" name="t4" class="wp-form-control wpcf7-text" placeholder="Enter T4 value" onkeypress="return onlyNumbers(event,this);" onchange="return onlyNumbers(event,this);">    
                              <br>
                        <p id="terror4"></p>                          
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                        ...
                        <div class="col-md-8 col-sm-8">
                              ...
                              <input type="text" id="height" name="height" class="wp-form-control wpcf7-text" placeholder="Height" onkeypress="return onlyNumbers(event,this);" onchange="return onlyNumbers(event,this);" >   
                              <br>
                        <p id="terror5"></p>                           
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                        ...
                        <div class="col-md-8 col-sm-8">
                              ...
                              <input type="text" id="weight" name="weight" class="wp-form-control wpcf7-text" placeholder="Weight" onkeypress="return onlyNumbers(event,this);" onchange="return onlyNumbers(event,this);">  
                              <br>
                        <p id="terror6"></p>                            
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                         ...
                         <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-share"></i><span>Analyse And Send</span></button>  
                         </div>
                         <div class="col-md-4 col-sm-4"></div>
                         </div>
                        </form>
