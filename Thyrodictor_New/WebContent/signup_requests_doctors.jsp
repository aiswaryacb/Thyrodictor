          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              <div class="blog-breadcrumbs-left">
                <h2>ADMINISTRATION - New Doctors</h2>
              </div>
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Doctor Signup Requests</li>
                </ol>
              </div>
            </div>
          </div>
...
%>          
     ...
     <section id="service">
      <div class="container">
                     ...
                     <%
              		int slno=1;
	              ResultSet rs = stmt.executeQuery("select * from doctor_details where doctor_status='requested';");
	              if(rs.next()){
	            	  %>
	            	  <table class="table">
	            	  <thead>
		            	  ...
		            	  <td>
		            	  <a href="signup_doctor_accept.jsp?doc_id=<%=rs.getString(1) %>">Accept</a>
		            	  &nbsp; &nbsp; &nbsp; &nbsp;
		            	  <a href="signup_doctor_deny.jsp?doc_id=<%=rs.getString(1) %>">Deny</a>
		            	  </td>
	            	  	</tr>
	            	  	<%
	                  while(rs.next()){
